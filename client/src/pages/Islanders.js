        ...
        <h1 className = "playercard-title">NHL Players:</h1>
          <div className='Card-body'>
            <div class = "main-container" key={players._id}>
              ...
              player.TeamID === 11 ? (<Player Name={player.Name} PlayerID={player.PlayerID} FantasyPoints={player.FantasyPoints} TeamID={player.TeamID} Position={player.Position} Team ={player.Team} id={player._id} key={player._id } value={index} />) :(<></>) 
              ))}  
