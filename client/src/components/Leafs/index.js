                            ...
                            <div className = "logoPlayer">
                                <h1>Player Card</h1>
                                    <ul className="navigationPlayer">
                                        <li>TeamID:{players[teamIDLeafs].TeamID}</li>
                                        <li>PlayerID:{players[teamIDLeafs].PlayerID}</li>
                                        <li>Name:{players[teamIDLeafs].Name}</li>
                                        <li>Team:{players[teamIDLeafs].Team}</li>
                                        <li>FantasyPoints:{players[teamIDLeafs].FantasyPoints}</li>
                                    </ul>
                            </div>
                        </div>    
                    </div>
