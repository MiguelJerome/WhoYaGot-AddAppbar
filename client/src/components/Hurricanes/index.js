                            ...
                            <div className = "logoPlayer">
                                <h1>Player Card</h1>
                                    <ul className="navigationPlayer">
                                        <li>TeamID:{players[teamIDHurricanes].TeamID}</li>
                                        <li>PlayerID:{players[teamIDHurricanes].PlayerID}</li>
                                        <li>Name:{players[teamIDHurricanes].Name}</li>
                                        <li>Team:{players[teamIDHurricanes].Team}</li>
                                        <li>FantasyPoints:{players[teamIDHurricanes].FantasyPoints}</li>
                                    </ul>
                            </div>
                        </div>    
                    </div>
