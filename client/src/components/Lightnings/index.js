                            ...
                            <div className = "logoPlayer">
                                <h1>Player Card</h1>
                                    <ul className="navigationPlayer">
                                        <li>TeamID:{players[teamIDLightning].TeamID}</li>
                                        <li>PlayerID:{players[teamIDLightning].PlayerID}</li>
                                        <li>Name:{players[teamIDLightning].Name}</li>
                                        <li>Team:{players[teamIDLightning].Team}</li>
                                        <li>FantasyPoints:{players[teamIDLightning].FantasyPoints}</li>
                                    </ul>
                            </div>
                        </div>    
                    </div>
