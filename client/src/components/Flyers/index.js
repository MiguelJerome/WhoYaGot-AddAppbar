                            ...
                            <div className = "logoPlayer">
                                <h1>Player Card</h1>
                                    <ul className="navigationPlayer">
                                        <li>TeamID:{players[teamIDFlyers].TeamID}</li>
                                        <li>PlayerID:{players[teamIDFlyers].PlayerID}</li>
                                        <li>Name:{players[teamIDFlyers].Name}</li>
                                        <li>Team:{players[teamIDFlyers].Team}</li>
                                        <li>FantasyPoints:{players[teamIDFlyers].FantasyPoints}</li>
                                    </ul>
                            </div>
                        </div>    
                    </div>
