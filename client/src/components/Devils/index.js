                            ...
                            <div className = "logoPlayer">
                                <h1>Player Card</h1>
                                    <ul className="navigationPlayer">
                                        <li>TeamID:{players[teamIDDevils].TeamID}</li>
                                        <li>PlayerID:{players[teamIDDevils].PlayerID}</li>
                                        <li>Name:{players[teamIDDevils].Name}</li>
                                        <li>Team:{players[teamIDDevils].Team}</li>
                                        <li>FantasyPoints:{players[teamIDDevils].FantasyPoints}</li>
                                    </ul>
                            </div>
                        </div>    
                    </div>
