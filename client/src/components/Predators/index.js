                            ...
                            <div className = "logoPlayer">
                                <h1>Player Card</h1>
                                    <ul className="navigationPlayer">
                                        <li>TeamID:{players[teamIDPredators].TeamID}</li>
                                        <li>PlayerID:{players[teamIDPredators].PlayerID}</li>
                                        <li>Name:{players[teamIDPredators].Name}</li>
                                        <li>Team:{players[teamIDPredators].Team}</li>
                                        <li>FantasyPoints:{players[teamIDPredators].FantasyPoints}</li>
                                    </ul>
                            </div>
                        </div>    
                    </div>
